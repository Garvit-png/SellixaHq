...
const personas = [
  { title: "Traders", desc: "Course on risk framework + indicator pack + branded storefront — sold to your followers.", avgLaunch: "$48K", icon: ArrowUpRight },
  { title: "Teachers", desc: "Exam-prep course, study workbooks, notes bundles — themed for your students.", avgLaunch: "$22K", icon: Music },
  { title: "Coding Instructors", desc: "DSA cohort course, system design ebook, interview kit — all branded as yours.", avgLaunch: "$61K", icon: Command },
  { title: "Fitness Coaches", desc: "Nutrition PDFs, workout mini-courses, transformation plans — styled, priced, launched.", avgLaunch: "$37K", icon: Circle },
];
  ...
  return (
    <section id="who-its-for" className="relative w-full min-h-screen flex flex-col justify-center py-32 overflow-hidden bg-[#050505]">
      ...
      <div className="max-w-[85rem] mx-auto w-full px-6 md:px-12 relative z-10 mt-12 md:mt-24">
        ...
        {/* Section Header */}
        <FadeIn className="flex items-center space-x-6 mb-10" delay={0}>
        ...
        {/* Title — TypeWriter */}
        <FadeUp delay={0.1} className="mb-20 max-w-4xl">
          <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-serif font-light leading-[1.05] tracking-tight">
            <span className="text-white">Built for creators with </span>
            <TypeWriter text="50k-2M" delay={0.5} speed={60} className="italic text-[#ffff00] font-bold" cursor={false} />
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="text-gray-300 text-[0.95rem] leading-[1.7] font-light mb-8">{persona.desc}</p>
                </div>
