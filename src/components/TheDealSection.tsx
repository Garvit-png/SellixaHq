  ...
  return (
    <section id="deal" className="relative w-full min-h-screen flex flex-col items-center justify-center py-16 md:py-32 overflow-hidden bg-[#ffff00]">
      <div className="absolute top-0 left-0 w-full z-30 pointer-events-none">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-[10vh] md:h-[15vh] text-[#000000] fill-current">
      ...
      <div className="max-w-[85rem] mx-auto w-full px-4 md:px-12 relative z-10 flex flex-col items-center mt-12 md:mt-24">
        ...
        >
          ...
          {/* Static Bars — no numbers, no animation */}
          <div className="w-full flex items-end gap-3 h-[130px] md:h-[150px] mb-10 rounded-[24px]">
            {/* Creator Bar — 70% */}
            <div
              className="relative h-[100px] md:h-[140px] bg-black flex flex-col justify-center items-center rounded-[16px] md:rounded-[20px] shadow-lg overflow-hidden"
              style={{ width: '70%' }}
            >
              <div className="absolute top-0 bottom-0 w-[150%] bg-gradient-to-r from-transparent via-white/40 to-transparent skew-x-[-25deg] animate-[shine_3s_ease-in-out_infinite]" />
              <span className="text-white/70 text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase relative z-10">
                Creator
              </span>
            </div>
            ...
            {/* Sellixa Bar — 30% */}
            <div
              className="h-[100px] md:h-[140px] bg-black/10 flex flex-col justify-center items-center rounded-[16px] md:rounded-[20px] border border-black/20 overflow-hidden"
              style={{ width: '30%' }}
            >
              <span className="text-black/60 text-[9px] md:text-[10px] font-bold tracking-[0.2em] uppercase">
                Sellixa
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-black/5 rounded-[16px] p-5 flex items-start gap-4 border border-black/10 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-black/10 cursor-pointer">
              <div className="w-8 h-8 rounded-full bg-black flex items-center justify-center flex-shrink-0 text-[#ffff00] text-xs font-bold font-mono">$0</div>
              <div>
            ...
            <div className="bg-black/5 rounded-[16px] p-5 flex items-start gap-4 border border-black/10 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-black/10 cursor-pointer">
              <div className="w-8 h-8 rounded-full bg-black flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffff00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
              </div>
              <div>
            ...
            <div className="bg-black/5 rounded-[16px] p-5 flex items-start gap-4 border border-black/10 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-black/10 cursor-pointer">
              <div className="w-8 h-8 rounded-full bg-black flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffff00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17l-5-5"></path></svg>
              </div>
              <div>
