...
export function FreeAuditSection() {
  ...
  return (
    <section id="audit" className="w-full py-24 md:py-32 bg-[#050505] relative z-20 overflow-hidden">
      {/* Paint spill */}
      ...
      <div className="max-w-6xl mx-auto w-full px-4 md:px-8 relative z-10 mt-12 md:mt-24">
