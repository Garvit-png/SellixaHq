      ...
      <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-0 px-4 md:px-8 pb-16 relative z-10">
        ...
        <div className="flex items-center space-x-6">
          <a href="#" className="flex items-center space-x-2 text-[#555555] hover:text-[#FACC15] transition-colors group">
            ...
            <span className="font-mono text-[10px] tracking-wide">@sellixa._hq</span>
          </a>
          <a href="mailto:contact@sellixahq.com" className="flex items-center space-x-2 text-[#555555] hover:text-[#FACC15] transition-colors group">
            <Mail className="w-4 h-4 group-hover:scale-110 transition-transform" />
            <span className="font-mono text-[10px] tracking-wide">contact@sellixahq.com</span>
          </a>
        </div>
